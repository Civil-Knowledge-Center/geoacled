...
from src.acled import AcledMonth
from src.acled.acled_db import acled_df_from_db, acled_df_to_db
from src.types import FeatureCollection
...
def fetch_geojson(country_name:str, adm:str) -> tuple[FeatureCollection, str]:
    try:
